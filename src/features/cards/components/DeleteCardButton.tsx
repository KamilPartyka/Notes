...
export const DeleteCardButton = ({ onClick }: DeleteCardButtonProps) => {
  ...
  return (
    <button
      ...
      type="button"
      className="cursor-pointer p-1.5 text-gray-800 transition-transform hover:scale-110 active:scale-95"
    >
      <svg
